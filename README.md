...
* Change the up/down/left/right based on the first monitor position, so if the first monitor is 1800x1080 instead of 1920x1080 I need to move the second monitor next to it, so instead of Right:1920x0 -> 1800x0 .
